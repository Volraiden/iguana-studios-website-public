...
const translations = {
    en: {
        ...
        'nav.contact': 'Contact',
        'hero.badge': 'Video Production Studio',
        ...
        'about.card1Text': 'Professional videographers and editors with deep industry experience',
        'about.card2Title': 'Quality First',
        'about.card2Text': 'State-of-the-art equipment and post-production techniques',
    ...
    ru: {
        ...
        'hero.badge': 'Видеопродакшн Студия',
        'hero.title1': 'Мы Создаем',
        'hero.highlight': 'Визуальные Истории',
        'hero.title2': 'Которые Захватывают',
        'hero.subtitle': 'Профессиональные видеооператоры и монтажеры воплощают ваше видение в жизнь через потрясающие рекламные ролики, фильмы и творческий контент.',
        ...
        'about.card1Text': 'Профессиональные видеооператоры и монтажеры с глубоким опытом в индустрии',
        'about.card2Title': 'Качество Превыше Всего',
        'about.card2Text': 'Современное оборудование и техники пост-продакшна',
    ...
    uz: {
        ...
        'nav.contact': 'Aloqa',
        'hero.badge': 'Video Ishlab Chiqarish Studiyasi',
        ...
        'about.card1Text': 'Tajribali videograf va muharrirlar bilan professional jamoa',
        'about.card2Title': 'Sifat Birinchi O\'rinda',
        'about.card2Text': 'Zamonaviy uskunalar va post-produksiya texnikalari',
